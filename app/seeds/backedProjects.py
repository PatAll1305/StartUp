...
def seed_backed_projects():
  backed_projects = [
    ...
    BackedProject(user_id=4, project_id=3, reward_id=None),
    BackedProject(user_id=5, project_id=4, reward_id=5),
    BackedProject(user_id=6, project_id=5, reward_id=4),
    BackedProject(user_id=7, project_id=6, reward_id=None),
    BackedProject(user_id=8, project_id=7, reward_id=6),
    BackedProject(user_id=9, project_id=8, reward_id=7),
    BackedProject(user_id=10, project_id=9, reward_id=8),
    BackedProject(user_id=1, project_id=10, reward_id=None),
    BackedProject(user_id=2, project_id=11, reward_id=9),
    BackedProject(user_id=3, project_id=12, reward_id=10),
    BackedProject(user_id=4, project_id=13, reward_id=None),
    BackedProject(user_id=5, project_id=14, reward_id=11),
    BackedProject(user_id=6, project_id=15, reward_id=12),
    BackedProject(user_id=7, project_id=16, reward_id=None),
    BackedProject(user_id=8, project_id=17, reward_id=13),
    BackedProject(user_id=9, project_id=18, reward_id=14),
